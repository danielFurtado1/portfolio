    ...
    return (
        <div>
            <section className="mw7 center  " id="projects">
                <h2 className="fw4 f2 ph3 ph0-l black">Projects</h2>
                    ...
                    <div className="db pv4 ph3 ph0-l no-underline black">
                        <div className="flex flex-column flex-row-ns">
                            ...
                            <div className="w-100 w-60-ns pl3-ns">
                                <h1 className="f3 fw4 mt0 lh-title">Robo Cards</h1>
                ...
                <article className="bb b--black-10 grow-custom">
                    <div className="db pv4 ph3 ph0-l no-underline black">
                        <div className="flex flex-column flex-row-ns">
                            ...
                            <div className="w-100 w-60-ns pl3-ns">
                                <h1 className="f3 fw4   mt0 lh-title">Face Recognition App</h1>
                                <p className="f6 f5-l lh-copy">
                ...
                <article className="bt bb b--black-10 grow-custom" >
                    <div className="db pv4 ph3 ph0-l no-underline black">
                        <div className="flex flex-column flex-row-ns">
                            ...
                            <div className="w-100 w-60-ns pl3-ns">
                                <h1 className="f3 fw4 mt0 lh-title">Monster Cards</h1>
                                <p className="f6 f5-l lh-copy">
                                    Renders cards using
                ...
                <article className="bb b--black-10 grow-custom">
                    <div className="db pv4 ph3 ph0-l no-underline black">
                        <div className="flex flex-column flex-row-ns">
                            ...
                            <div className="w-100 w-60-ns pl3-ns">
                                <h1 className="f3 fw4 mt0 lh-title">Personal Portfolio</h1>
                                <p className="f6 f5-l lh-copy">
