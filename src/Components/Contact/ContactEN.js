        ...
        <div>
            <footer className="tc-l bg-center cover bg-black" id="contact">
                <div className="w-100 ph3 pt7 pb7 bg-black-80">
                    <p className="f3 white-60 pb6 contact-text">Contact me!</p>
                    ...
                    <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://github.com/danielFurtado1" title="GitHub" rel="noopener noreferrer" target='_blank'>
                    ...
                    <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://www.linkedin.com/in/danielbmfurtado/" title="LinkedIn" rel="noopener noreferrer" target='_blank'>
